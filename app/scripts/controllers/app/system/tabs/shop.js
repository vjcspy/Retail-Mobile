 ...
 */
app
  .controller('ShopConfigCtrl', ['$scope', '$mdDialog', 'appConfigData',
    function ($scope, $mdDialog, appConfigData) {
      $scope.toppings = [
      ...
      $scope.settings = [
        {name: 'Wi-Fi', extraScreen: 'Wi-fi menu', icon: 'ion-ios-cloud-outline', enabled: true},
        {name: 'Mobile-Data', extraScreen: 'Mobile data menu', icon: 'ion-ios-pie-outline', enabled: false}
      ];
      $scope.messages = [
